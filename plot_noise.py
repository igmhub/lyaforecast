...
spec = sp.Spectrograph()
lmin,lmax = spec.range_lobs_A()
l = np.linspace(lmin,lmax,1000)
plot_quasar(z=2.5,mag=22.0,lobs=l)
plot_quasar(z=2.5,mag=22.5,lobs=l)
plot_quasar(z=3.0,mag=22.0,lobs=l)
plot_quasar(z=3.0,mag=22.5,lobs=l)
