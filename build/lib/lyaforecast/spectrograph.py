...
class Spectrograph:
    ...
    def __init__(self, config, survey):
        ...
        #list of filenames, I'm forcing only selecting one band. Inflexible.
        self._filenames = list(self._snr_file_dir.glob(f'*lya-{self._band}*'))
    ...
    def _read_file(self,mag):
        ...
        fname = self._snr_file_dir.joinpath(f'sn-spec-lya-201809070-{self._band}{mag}-t{str(self._file_exp_time)}-nexp{self._file_num_exp}.dat')
